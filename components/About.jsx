    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            I have spent the last 2 years in the IT industry as a
            professional Front-end web developer. I have always had a knack for
          ...
          <p className='py-2 text-gray-600'>
            ...
            freelancing for e-commerce companies on the Upwork platform. I am
